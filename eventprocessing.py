...
#flow.AddCppCode('\n#include "tfeval.h"\n')
flow.Define("DNNClassifier","0.9")
#flow.Define("DNNAtan","0.9")
#flow.Define("DNNClassifier","tfmodel.tfeval(__slot,{Higgs_m,Higgs_mRelReso,Higgs_mReso,ll_zstar,Higgs_pt,log(Higgs_pt),Higgs_eta,Mqq_log,Mqq,Rpt,qqDeltaEta,EtaHQ1,EtaHQ2,QJet0_pt,QJet1_pt,QJet0_eta,QJet1_eta,QJet0_phi,QJet1_phi,float(NSoft5)})")
