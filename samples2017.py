...
"DY105_2017MGPY"      : {"xsec": 41.25, "filter":  "VBFFilterAntiFlag"},
...
"DY105VBF_2017MGPY"   : {"xsec": 41.25*0.0419533, "filter":  "VBFFilterFlag"},
...
"EWKZ105_2017MGHERWIG"     : {"xsec":0.0508896},
...
"TT_2017AMCPY"      : {"xsec":809.},    #generator is different from 2016
...
"vbfHmm_2017POWPY"      : {"xsec":0.0008210722},
...
for sample in samples:
    if not "files" in samples[sample].keys():
        samples[sample] = [path2017+sample+".root"]
